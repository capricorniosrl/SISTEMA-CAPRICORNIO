...
if ($contador == 0) {
    ...
    if (isset($_POST['mi_checkbox'])) { //ESTA MARCADO REPROGRAMAR
        ...
        $sql = $pdo->prepare('INSERT INTO tb_clientes (nombres,apellidos, ci_cliente,tipo_urbanizacion,reprogramar,detalle_llamada,detalle,fecha_registro,fecha_llamada,hora_llamada,created_at,updated_at,estado,id_usuario_fk,id_contacto_fk)VALUES (:nombres,:apellidos,:ci_cliente,:tipo_urbanizacion,:reprogramar,:detalle_llamada,:detalle,:fecha_registro,:fecha_llamada,:hora_llamada,:created_at,:updated_at,:estado,:id_usuario_fk,:id_contacto_fk)');
        ...
        $sql->bindParam(':ci_cliente', $ci_cliente);
