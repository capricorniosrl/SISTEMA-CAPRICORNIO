...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $nombre_urbanizacion = $_POST['nombre_urbanizacion'];
    ...
    try {
        ...
        $sql_buscar = $pdo->prepare("SELECT us.id_usuario, ag.detalle_agenda, ag.visitantes, us.nombre as nom_user, us.ap_paterno, us.ap_materno, cli.nombres as nombre_usuario, cli.apellidos, cli.tipo_urbanizacion, ag.fecha_visita, UPPER(cli.detalle) as detalle, ag.asistio FROM tb_clientes cli INNER JOIN tb_agendas ag INNER JOIN tb_usuarios us WHERE cli.tipo_urbanizacion='$nombre_urbanizacion' AND ((( ag.id_cliente_fk=cli.id_cliente) AND ag.id_usuario_fk = us.id_usuario) AND ag.estado=1) AND ag.fecha_visita BETWEEN '$fecha_inicio' AND '$fecha_fin' ORDER BY us.nombre, ag.fecha_visita");
        ...
        class PDF extends FPDF{
            ...
            function Header()
            {
                ...
                $this->Cell(0,8,'URBANIZACION: '. $this->nombre_urbanizacion1,0,1,'C');
        ...
        $pdf->nombre_urbanizacion1 = $nombre_urbanizacion;
        ...
        $x = $pdf->GetX();
        $y = $pdf->GetY();
        $pdf->Cell(50, 8, 'NOMBRES Y APELLIDOS CLIENTE', 1,0,'C',true);
        $pdf->SetFont('Arial', 'B', 9);
        ...
        $pdf->Cell(0, 8, 'DETALLES', 1,0,'C',true);
        $pdf->Ln();
        ...
        foreach ($id_ususario_buscar as $dato_id) {
            ...
            foreach ($clientes as $cliente) {
                ...
                if ($cliente['id_usuario']==$dato_id['id_usuario']) {
                    ...
                    $pdf->Cell(50, 5, $cliente['nombre_usuario']." ".$cliente['apellidos'], 'T',0);
        ...
        echo json_encode([
            ...
            'id_cliente' => "General_Urbanizacion_".$nombre_urbanizacion,
