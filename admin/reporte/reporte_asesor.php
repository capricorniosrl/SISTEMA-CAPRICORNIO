      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Por Asesor</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
<script>
  $('#clientForm').on('submit', function(e) {
    ...
    $.ajax({
      url: 'controller_generar_pdf_asesor.php',
      type: 'POST',
      data: {
      ...
      success: function(response) {
        if (response.error) {
          ...
          $('#pdf-preview').html(`
                        ...
                        <a href="${response.pdf_url}" download="reporte_asesor_${response.id_cliente}.pdf" class="btn btn-success mt-2 mb-2">Descargar PDF</a>
                         <br>
