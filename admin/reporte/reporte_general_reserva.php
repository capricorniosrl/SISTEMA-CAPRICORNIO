  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card card-default">
        ...
        <div class="card-body">
          <div class="row ">
            <form class="container" id="clientForm">
              <div class="row">
...
<script>
  $('#clientForm').on('submit', function(e) {
    ...
    $.ajax({
      url: 'controller_generar_pdf_general_reserva.php',
      type: 'POST',
      data: {
      ...
      success: function(response) {
        if (response.error) {
          ...
          $('#pdf-preview').html(`
                        ...
                        <a href="${response.pdf_url}" download="reporte_cliente_${response.id_cliente}.pdf" class="btn btn-success mt-2 mb-2">Descargar PDF</a>
                         <br>
