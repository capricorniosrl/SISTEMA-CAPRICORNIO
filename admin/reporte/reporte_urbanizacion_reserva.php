      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">Reportes</a></li>
            <li class="breadcrumb-item">Clientes con Reserva</li>
            <li class="breadcrumb-item active">Por Urbanizacion</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">Listar de Urbanizaciones</h3>
              ...
              <div class="row">
                <div class="col-12 col-sm-4">
                  <div class="form-group">
                    <label>Lista de Urbanizacion</label>
                    <select id="nombre_urbanizacion" name="nombre_urbanizacion" class="form-control select2 select2-primary" data-dropdown-css-class="select2-info" style="width: 100%;" required>
...
<script>
  $('#clientForm').on('submit', function(e) {
    ...
    const nombre_urbanizacion = $('#nombre_urbanizacion').val();
    const clienteInicio = $('#fecha_inicio').val();
    const clienteFin = $('#fecha_fin').val();

    $.ajax({
      url: 'controller_generar_pdf_urbanizacion_reserva.php',
      type: 'POST',
      data: {
