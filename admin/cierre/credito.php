...
<?php
$id = $_GET['id'];
$sql = $pdo->prepare("SELECT info.id_informe, info.precio_acordado, cli.ci_cliente, cli.exp_cliente, info.fecha_limite_pago, info.tipo_cambio, UPPER(cli.nombres) as nombres, cli.apellidos, con.celular,info.monto, UPPER(info.tipo_pago) as tipo_pago, info.num_recibo, info.num_transferencia, cli.tipo_urbanizacion, UPPER(info.lote) as lote, UPPER(info.manzano) as manzano, info.superficie FROM tb_informe info INNER JOIN tb_agendas ag INNER JOIN tb_clientes cli INNER JOIN tb_usuarios us INNER JOIN 	tb_contactos con WHERE (((id_informe='$id' AND info.id_agenda_fk = ag.id_agenda) AND ag.id_cliente_fk = cli.id_cliente) AND ag.id_usuario_fk = us.id_usuario) AND con.id_contacto = cli.id_contacto_fk");
$sql->execute();
...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1 class="m-0 ">CIERRE A CREDITO PARA LA URBANIZACION <span class="text-primary"><?php echo $dato['tipo_urbanizacion'] ?></span></h1>
      ...
      <div class="row ">
        <div class="col-12 col-sm-12">
          <div class="card card-danger card-outline card-outline-tabs">
            ...
            <form id="formulario_credito" novalidate>
              <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class=" col-sm-1 col-lg-1 col-md-6">
                        <div class="form-group">
                          <label>EXP</label>
                          <div class="input-group">
                            <select name="exp_1" id="" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                              <div class="col-12">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" value="<?php echo $dato['fecha_limite_pago'] ?>" name="cantidadCuotas" id="cantidadCuotas" min="1" placeholder="Número de cuotas">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-6">
                            <div class="row">
                              ...
                              <input type="text" name="cuota_inicial_literal" id="cuota_inicial_literal" class="form-control d-none" placeholder="MONTO LITERAL">
                              ...
                              <script>
                                ...
                                function actualizarLiteral() {
                                  const inputNumero = document.getElementById('cuota_inicial');
                                  const inputLiteral = document.getElementById('cuota_inicial_literal');
                                ...
                                document.getElementById('cuota_inicial').addEventListener('input', actualizarLiteral);
                              </script>
                          ...
                          <div class="col-sm-12 col-lg-6">
                            <div class="form-group">
                              <label>Ingrese el monto de Interes a designar al terreno <span class="badge badge-pill badge-primary"><?php echo $dato['tipo_urbanizacion'] ?></span> </label>
                              <div class="input-group mb-3">
                                <input type="number" class="form-control" name="interes" id="interes" placeholder="INGRESE EL INTERES EN DOLARES">
                                <div class="input-group-append">
                                  <span class="input-group-text">$</span>
                                </div>
                              </div>
...
<script src="script_credito.js"></script>