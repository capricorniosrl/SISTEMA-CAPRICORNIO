...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      ...
      <?php
      $id = $_GET['id'];
      $sql = $pdo->prepare("SELECT info.id_informe,cli.ci_cliente, cli.exp_cliente, info.tipo_cambio,info.precio_acordado, UPPER(cli.nombres) as nombres, cli.apellidos, con.celular,info.monto, UPPER(info.tipo_pago) as tipo_pago, info.num_recibo, info.num_transferencia, cli.tipo_urbanizacion, UPPER(info.lote) as lote, UPPER(info.manzano) as manzano, info.superficie FROM tb_informe info INNER JOIN tb_agendas ag INNER JOIN tb_clientes cli INNER JOIN tb_usuarios us INNER JOIN 	tb_contactos con WHERE (((id_informe='$id' AND info.id_agenda_fk = ag.id_agenda) AND ag.id_cliente_fk = cli.id_cliente) AND ag.id_usuario_fk = us.id_usuario) AND con.id_contacto = cli.id_contacto_fk");
      $sql->execute();
      ...
      <div class="row">
        <div class="col-12 col-sm-12">
          <div class="card card-primary card-outline card-outline-tabs">
            ...
            <form id="formulario_contado" novalidate>
              <div class="card-body">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                    <div class="row">
                          ...
                          <div class="col-12">
                            ...
                            <div class="card-body">
                              <dl class="row">
                                ...
                                <dt class="col-lx-4 col-lg-4 col-md-5 col-sm-6 col-6">TIPO CAMBIO:</dt>
                                <dd class="col-lx-8 col-lg-8 col-md-6 col-sm-6 col-6"><?php echo "1 $ = " . $dato['tipo_cambio'] ?> Bs</dd>

                                <dt class="col-lx-4 col-lg-4 col-md-5 col-sm-6 col-6">MONTO RESERVADO:</dt>
                                <dd class="col-lx-8 col-lg-8 col-md-6 col-sm-6 col-6"> <?php echo $dato['monto'] + $dato_suma['monto_aumento'] ?> Bolivianos </dd>

                                <dt class="col-lx-4 col-lg-4 col-md-5 col-sm-6 col-6">MONTO RESERVADO:</dt>
                                <dd class="col-lx-8 col-lg-8 col-md-6 col-sm-6 col-6">
                                  <h5 class="badge badge-primary text-left" style="font-size: 15px;"><?php echo round(($dato['monto'] + $dato_suma['monto_aumento']) / $dato['tipo_cambio'], 2) ?> Dólares</h5>
                                </dd>

                                <dt class="col-lx-4 col-lg-4 col-md-5 col-sm-6 col-6">MONTO ACORDADO:</dt>
                                <dd class="col-lx-8 col-lg-8 col-md-6 col-sm-6 col-6">
                                  <h5 class="badge badge-primary text-left" style="font-size: 15px;"><?php echo $dato['precio_acordado']; ?> Dólares</h5>
                                </dd>

                                <dt class="col-lx-4 col-lg-4 col-md-5 col-sm-6 col-6">TIPO DE PAGO:</dt>
                                <dd class="col-lx-8 col-lg-8 col-md-6 col-sm-6 col-6"><?php echo $dato['tipo_pago'] ?></dd>

                                <?php
                                if ($dato['num_recibo']) {
                                ?>
                                  <dt class="col-lx-4 col-lg-4 col-md-5 col-sm-6 col-6">NRO. DE RECIBO:</dt>
                                  <dd class="col-lx-8 col-lg-8 col-md-6 col-sm-6 col-6"><?php echo $dato['num_recibo'] ?></dd>
                                  <?php
                                } else {
                                  if ($dato['num_transferencia']) {
                                  ?>
                                    <dt class="col-lx-4 col-lg-4 col-md-5 col-sm-6 col-6">NRO. DE TRANSFERENCIA:</dt>
                                    <dd class="col-lx-8 col-lg-8 col-md-6 col-sm-6 col-6"><?php echo $dato['num_transferencia'] ?></dd>
                                <?php
                                  }
                                }
                                ?>
                      ...
                      <div class="col-sm-12 col-md-12 col-12 col-lg-8">
                          ...
                          <div class="col-12">
                            ...
                            <div class="row">
                              <div class="col-sm-6 col-md-12 col-lg-12 col-xl-6">
                                ...
                                <?php
                                $monto_pagar = $dato['precio_acordado'] - round(($dato['monto'] + $dato_suma['monto_aumento']) / $dato['tipo_cambio'], 2);
                                ?>
                                <label for="">PRECIO EN DOLARES<small> EL PRECIO INCLUYE EL DESCUENTO DE LA RESERVA DE <?php echo round(($dato['monto'] + $dato_suma['monto_aumento']) / $dato['tipo_cambio'], 2) . " $" ?></small></label>
                                <div class="input-group mb-3">
                                  <input type="number" class="form-control" value="<?php echo $monto_pagar ?>" name="precio_dolares" id="precio_dolares" placeholder="Precio en Dolares">
                        ...
                        <script>
                          // Calcular el total y actualizar el literal al cargar la página
                          ...
                          document.getElementById('moneda').addEventListener('change', convertNumberToLiteral);
                    ...
                    <div class="row justify-content-center">
                      <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group mb-3">
                              <input type="text" class="form-control" value="<?php echo $dato['superficie'] ?>" name="superficie" id="superficie" placeholder="Superficie">
                              <div class="input-group-append">
...
<script src="script_contado.js"></script>
