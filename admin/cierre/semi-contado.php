         ...
         <div class="row ">
          <div class="col-12 col-sm-12">
            <div class="card card-danger card-outline card-outline-tabs">
              ...
              <form action="create_controller_semicontado.php" method="post">
                <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-7 col-12 col-md-8">
                            ...
                            <script>
                              ...
                              const montoReserva = <?php echo $dato['monto']; ?>;
                          ...
                          <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <label>Seleccionar Cuotas</label>
                                  <select class="select2" multiple="multiple" name="cuotas[]" data-placeholder="Seleccionar Funciones" style="width: 100%;">
                                      <option value="1° Cuota" selected>1° Cuota</option>
                                      <option value="2° Cuota" selected>2° Cuota</option>
                                      <option value="3° Cuota" selected>3° Cuota</option>
                                      <option value="4° Cuota">4° Cuota</option>
                                      <option value="5° Cuota">5° Cuota</option>
                                      <option value="6° Cuota">6° Cuota</option>
                                      <option value="7° Cuota">7° Cuota</option>
                                      <option value="8° Cuota">8° Cuota</option>
                                      <option value="9° Cuota">9° Cuota</option>
                                      <option value="1° Cuota">10° Cuota</option>
                                      <option value="11° Cuota">11° Cuota</option>
                                      <option value="12° Cuota">12° Cuota</option>
                                      <option value="13° Cuota">13° Cuota</option>
                                      <option value="14° Cuota">14° Cuota</option>
                                      <option value="15° Cuota">15° Cuota</option>
                                      <option value="16° Cuota">16° Cuota</option>
                                      <option value="17° Cuota">17° Cuota</option>
                                      <option value="18° Cuota">18° Cuota</option>
                                      <option value="19° Cuota">19° Cuota</option>
                                      <option value="20° Cuota">20° Cuota</option>
                                  </select>
                                </div>
                                <div class="col-6">
                                  <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                          <div class="card-body">
                            <dl class="row">
                              ...
                              <dd class="col-sm-8">
                                <input type="text" name="numero_recibo" id="" class="form-control" placeholder="INGRESE EL NUMERO DEL RECIBO DE LA CUOTA INICIAL" required>
                              </dd>
                            </dl>
                          </div>
                        </div>  
