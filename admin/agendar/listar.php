                  ...
                  <table id="example" class="display " style="width:100%">
                    ...
                    <tbody>
                      <!-- PREPARAMOS LA CONSULTA APRA LISTAR LOS USUARIOS DE LA BASE DE DATOS -->
                        <?php
                            $query=$pdo->prepare("SELECT ag.detalle_agenda, ag.id_agenda, ag.asistio, ag.fecha_visita, ag.visitantes, ag.detalle, cli.tipo_urbanizacion, cli.nombres, cli.apellidos, con.celular, UPPER(cli.detalle) as detalle_cliente FROM tb_contactos con INNER JOIN tb_clientes cli INNER JOIN tb_agendas ag
                            WHERE 
                            ((((ag.estado=1 AND ag.id_cliente_fk = cli.id_cliente) AND cli.id_contacto_fk = con.id_contacto)
                            AND ag.id_usuario_fk='$id_usuario')
                            AND ag.estado=1) ORDER BY ag.fecha_visita DESC");
                            $query->execute();
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-append">
                                            ...
                                            ?>
                                                ...
                                                <a target="_blank" href="../reportes/index.php?id=<?php echo $id_agenda;?>"><i class="fas fa-file-pdf fa-2x ml-2 text-danger"></i></a>
