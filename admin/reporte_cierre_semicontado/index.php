...
$sql=$pdo->prepare("SELECT us.nombre, us.ap_paterno, us.ap_materno, info.id_informe, semicon.num_recibo_inicial, com.nombre_1, com.ap_paterno_1, com.ap_materno_1, com.ci_1, com.exp_1, com.nombre_2, com.ap_paterno_2, com.ap_materno_2, com.ci_2, com.exp_2, semicon.literal, semicon.monto_bolivianos, semicon.concepto, us.nombre, us.ap_paterno, us.ap_materno, semicon.monto_dolar, semicon.fecha_registro, semicon.superficie, semicon.lote, semicon.manzano, semicon.urbanizacion
FROM tb_semicontado semicon
...
WHERE ((((((semicon.id_comprador_fk=com.id_comprador AND com.id_usuario_fk=us.id_usuario) AND us.id_usuario=ag.id_usuario_fk) AND info.id_agenda_fk=ag.id_agenda) AND us.id_usuario='$id_usuario') AND info.id_informe='$id') AND ag.id_cliente_fk=cli.id_cliente) AND (us.id_usuario=cont.id_usuario_fk AND cli.id_contacto_fk=cont.id_contacto) AND (com.celular_1=cont.celular)");
...
class PDF extends FPDF{
    ...
    function Header()
    {
        $this->Image('../../public/img/logo.png',20,5,60,15,'PNG');
...
$pdf->Cell(0,8,'Nro. '.$datos['num_recibo_inicial'] ,0,1,'R');
...
$pdf->Cell(0,7,'SEMICONTADO' ,0,1,'L');
