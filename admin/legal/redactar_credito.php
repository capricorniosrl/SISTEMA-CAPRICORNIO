...
$sql = $pdo->prepare("SELECT info.*, comp.*, cre.* 
...
INNER JOIN tb_credito cre
WHERE (((((info.id_agenda_fk=ag.id_agenda) AND ag.id_cliente_fk=cli.id_cliente) AND ag.id_usuario_fk=us.id_usuario) AND US.id_usuario=comp.id_usuario_fk) AND cre.id_comprador_fk=comp.id_comprador) AND (info.id_informe='$id_info' AND comp.id_comprador='$id_comp')");
$sql->execute();
