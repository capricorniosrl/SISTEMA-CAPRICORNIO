                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <a href="redactar_semicontado.php?id_comp=<?php echo $usuario['id_comprador'] ?>&id_info=<?php echo $usuario['id_informe'] ?>" class="btn btn-outline-primary"> REDACTAR </a>
                                            <?php
                                    ...
                                    <tr>
                                      ...
                                      AND cu.monto > 0");
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <a href="redactar_credito.php?id_comp=<?php echo $usuario['id_comprador'] ?>&id_info=<?php echo $usuario['id_informe'] ?>" class="btn btn-outline-primary"> REDACTAR </a>
                                            <?php
