...
if ($error=="") {
    ...
    $sql = $pdo->prepare('UPDATE tb_cuotas SET monto=:monto,tipo_pago=:tipo_pago,fecha_registro_pago=:fecha_registro_pago,numero_recibo=:numero_recibo WHERE id_semicontado_fk=:id_semicontado_fk AND id_cuota=:id_cuota ');
    ...
    $sql->bindParam(':id_semicontado_fk',$id_semicontado);
