...
<div class="content-wrapper">
  <div class="content-header">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-lg-4 col-md-6 col-sm-12">
                            ...
                            $sql=$pdo->prepare("SELECT * FROM tb_semicontado semi
                            ...
                            WHERE (((((((semi.id_comprador_fk=comp.id_comprador) AND comp.id_usuario_fk=us.id_usuario) AND ag.id_usuario_fk=us.id_usuario) AND info.id_agenda_fk=ag.id_agenda) AND ag.id_cliente_fk=cli.id_cliente) AND cli.id_contacto_fk=con.id_contacto) AND cli.id_usuario_fk=us.id_usuario)
                            AND (comp.id_comprador='$id_comprado' AND con.celular=comp.celular_1 )");
                            ...
                            <dl class="row">
                              ...
                              <dd class="col-sm-8"><?php echo $datos['nombre_1']." ".$datos['ap_paterno_1']." ".$datos['ap_materno_1']?></dd>

                              <dt class="col-sm-4">CI:</dt>
                              <dd class="col-sm-8"><?php echo $datos['ci_1']." ".$datos['exp_1']?></dd>

                              <dt class="col-sm-4">CELULAR:</dt>
                              <dd class="col-sm-8"><?php echo $datos['celular_1']?></dd>   
                            ...
                            <?php
                                ...
                                <dt class="col-sm-4">NOMBRE COMPLETO:</dt>
                                <dd class="col-sm-8"><?php echo $datos['nombre_2']." ".$datos['ap_paterno_2']." ".$datos['ap_materno_2']?></dd>

                                <dt class="col-sm-4">CI:</dt>
                                <dd class="col-sm-8"><?php echo $datos['ci_2']." ".$datos['exp_2']?></dd>

                                <dt class="col-sm-4">CELULAR:</dt>
                                <dd class="col-sm-8"><?php echo $datos['celular_2']?></dd>   
                        ...
                        <div class="col-12 col-lg-5 col-md-12 col-sm-12">
                            ...
                            <hr class="text-primary bg-primary" style="height: 3px;">
                            <dl class="row">
                                <dt class="col-sm-6">PRECIO DE VENTA ACORDADO:</dt>
                                <dd class="col-sm-6"><?php echo $datos['monto_dolar']." Dólares"?></dd>

                                <dt class="col-sm-6">TIPO CAMBIO:</dt>
                                <dd class="col-sm-6"><?php echo  "1 $"."us. = ". $datos['tipo_cambio']." Bs."?></dd>

                                <dt class="col-sm-6">CUOTA INICIAL:</dt>
                                <dd class="col-sm-6"><?php echo $datos['cuota_inicial']." Dólares"?></dd>

                                <dt class="col-sm-6">RESERVA TERRENO:</dt>
                                <dd class="col-sm-6"><?php echo $datos['monto']."Bs = ".round($datos['monto']/$datos['tipo_cambio'],2)." Dólares"?></dd>

                                <?php

                                $id_semicontado=$datos['id_semicontado'];
                                ...
                                <dt  class="col-sm-6">Nro. CUOTAS A CANCELAR:</dt>

                                <?php
                                $reserva=round($datos['monto']/$datos['tipo_cambio'],2);
                                $cuota_inicial=$datos['cuota_inicial'];
                                $total= (($datos['monto_dolar']-$datos['cuota_inicial'])-$reserva)/$dato2['cuotas'];
                                
                                ?>

                                <dd class="col-sm-6"><?php echo $dato2['cuotas']." Coutas de <span class='badge badge-danger'style='font-size: 16px;''>". round($total,2)."</span> Dolares" ?></dd> 

                                <dt class="col-sm-6">FECHA INICIO:</dt>
                                <dd class="col-sm-6"><?php echo date("d/m/Y", strtotime($datos['fecha_registro']))?></dd> 
                                <dt class="col-sm-6">FECHA FIN:</dt>
                                ...
                                <dd class="col-sm-6"><?php echo date("d/m/Y", strtotime($fecha_nueva))?></dd> 
                            </dl>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                          <a class="btn btn-primary" id="btnAgregarCuota" data-id="<?php echo $datos['id_semicontado']; ?>">
    ...
    $('#btnAgregarCuota').click(function(e) {
        ...
        var idSemicontado = $(this).data('id');
        
        $.ajax({
            url: 'agregar_cuota.php',
            type: 'POST',
            data: { id_semicontado: idSemicontado },
            ...
            error: function(xhr, status, error) {
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Aceptar'
                          ...
                          <a target="_blank" href="../reporte_semicontado/index.php?id=<?php echo $id_comprado?>">Reporte General <img src="../../public/img/print.ico" alt="" height="45px"></a>
                          <button type="button" class="btn btn-tool" data-card-widget="collapse">
                            <i class="fas fa-minus"></i>
                          </button>
                        </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped " id="tabla_cuotas">                 
                            <thead>
                              <tr>
                                <th>Nro.</th>
                                <th>Cuota</th>
                                        ...
                                        echo "<td class='bg-success'>";
                                          ...
                                          <div class="collapse" id="detalles<?php echo $contador; ?>">
                                              <div class="card card-body text-dark">
                                                ...
                                                <a target="_blank" class="btn btn-danger btn-block" href="../reporte_semicontado/pagos_cuotas.php?id=<?php echo $id_comprado?>&id_cuota=<?php echo $valor['id_cuota']?>">GENERAR PDF</a>
                                              </div>
                                          </div>
                                          <?php
                                        echo "</td>";
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form action="" id="formulario-pagos" novalidate>
                        ...
                        <label for="" hidden>id_semicontado = <input name="id_semicontado" type="text" value="<?php echo $datos['id_semicontado'] ?>"></label>
