              ...
              <div class="card card-danger">
                ...
                <form action="controller_delete.php" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4 col-12 ">
                        <div class="form-group">
                          ...
                          <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Ingrese nombre completo" value="<?php echo $nombre?>" disabled/>
                        </div>
                      </div>
                      <div class="col-sm-4 col-12 ">
                        <div class="form-group">
                          <label for="paterno">Apellido Paterno</label>
                          <input type="text" name="paterno" class="form-control" id="paterno" placeholder="Ingrese Apellido Paterno"  value="<?php echo $ap_paterno?>" disabled/>
                        </div>
                      </div>
                      <div class="col-sm-4 col-12 ">
                        <div class="form-group">
                          <label for="materno">Apellido Materno</label>
                          <input type="text" name="materno" class="form-control" id="materno" placeholder="Ingrese Apellido Materno" value="<?php echo $ap_materno?>" disabled/>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3 col-12">
                        <div class="form-group">
                          ...
                          <input type="number" name="ci" class="form-control" id="ci" placeholder="Ingrese numero de Carnet de Identidad" value="<?php echo $ci?>" disabled/>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-2 col-12">
                        <div class="form-group">
                          ...
                          <select id="cargo" name="exp" class="form-control" disabled>
                      ...
                      <div class="col-sm-3 col-12">
                        <div class="form-group">
                          ...
                          <input type="number" name="celular" class="form-control" id="celular" placeholder="77777777" value="<?php echo $celular?>" disabled/>
                        </div>
                      </div>
                      <div class="col-sm-4 col-12">
                        <div class="form-group">
                      ...
                      <div class="col-sm-6 col-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="direccion" class="form-control" id="email" placeholder="Ingrese La direccion de su Domicilio"  value="<?php echo $direccion?>" disabled/>
                        </div>
                      </div>
                      <div class="col-sm-6 col-12">
                        <div class="form-group">
                          <label for="email">Correo Electronico <span class="text-danger" >(*)</span></label>
                          <input type="email" name="correo" class="form-control" id="email" placeholder="juan@example.com" value="<?php echo $email?>" disabled/>
                        </div>
                      </div>
                  ...
                  <div class="card-footer">
                    ...
                    <button type="submit" class="btn btn-outline-danger" onclick="return confirm('ESTA SEGUDO DE ELIMINAR A ESTE USUARIO')">ACTUALIZAR DATOS DEL USUARIO</button>
                  </div>
                </form>
              </div>
            </div>
