...
WHERE ((cu.id_credito_fk=semi.id_credito) AND semi.id_comprador_fk=com.id_comprador) AND id_cuota=$id_cuota ");
...
$url = "$URL/verificar_credito/?idcu=" . urlencode(base64_encode($encrypted_number . '::' . base64_encode($iv)));
