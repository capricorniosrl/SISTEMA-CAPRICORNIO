...
<head>
  ...
  <title>Sistema Capricornio</title>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-dark bg-dark">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        ?>
          <!-- Notificacion Parte Legal -->
          <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
              <i class="far fa-solid fa-bell fa-lg" id="mensaje"></i>
              ...
              $query = $pdo->prepare("SELECT semi.cuota_interes, info.monto, semi.tipo_cambio, semi.cuota_inicial, info.monto, info.lote,info.manzano, info.superficie, info.id_informe, us.id_usuario, com.*, semi.* FROM tb_credito semi INNER JOIN tb_comprador com INNER JOIN tb_usuarios us INNER JOIN tb_agendas ag INNER JOIN tb_clientes cli INNER JOIN tb_contactos cont INNER JOIN tb_informe info WHERE (((((semi.id_comprador_fk=com.id_comprador AND com.id_usuario_fk=us.id_usuario) AND us.id_usuario=ag.id_usuario_fk) AND info.id_agenda_fk=ag.id_agenda) AND ag.id_cliente_fk=cli.id_cliente) AND (us.id_usuario=cont.id_usuario_fk AND cli.id_contacto_fk=cont.id_contacto) AND (com.celular_1=cont.celular)) AND estado_doc_priv=0 GROUP BY semi.id_comprador_fk");
              ...
              FROM tb_contado con INNER JOIN tb_comprador com INNER JOIN tb_usuarios us INNER JOIN tb_agendas ag INNER JOIN tb_clientes cli INNER JOIN tb_contactos cont INNER JOIN tb_informe info WHERE (((((con.id_comprador_fk=com.id_comprador AND com.id_usuario_fk=us.id_usuario) AND us.id_usuario=ag.id_usuario_fk) AND info.id_agenda_fk=ag.id_agenda) AND ag.id_cliente_fk=cli.id_cliente) AND (us.id_usuario=cont.id_usuario_fk AND cli.id_contacto_fk=cont.id_contacto) AND (com.celular_1=cont.celular)) AND estado_doc_priv=0");
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p class=""><strong>TIENE <?php echo $contador ?> PENDIENTES </strong> PARA REDACTAR SU DOCUMENTO PRIVADO DE INTERMEDIACION </p>
                  </div>
                </div>
                <!-- Message End -->
              </a>
              ...
              <a href="<?php echo $URL ?>/admin/legal/index.php" class="dropdown-item dropdown-footer bg-primary">VER TUS PENDIENTES</a>
            </div>
          </li>
        <?php
        }
        ...
        <!-- Mensajes de Reprogramar Llamada -->
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2" id="panel_guia">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            ?>
              ...
              <li class="nav-item ">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="ml-3 nav-item">
                    <a href="<?php echo $URL; ?>/admin/usuarios/restaurar_usuario.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Buscar y Restaurar</p>
                    </a>
                  </li>
                </ul>
              </li>
            ...
            if (isset($_SESSION['session_restaurar_contraseña'])) {
            ?>
            ...
            <?php
              ...
              unset($_SESSION['session_restaurar_contraseña']);
            }
            ...
            ?>
              ...
              <li class="nav-item ">
                ...
                <ul class="nav nav-treeview">
                  <li class="ml-3 nav-item">
                    <a href="<?php echo $URL; ?>/admin/cierre_directo/index.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
            ...
            <?php
              ...
              unset($_SESSION['session_cierre_directo']);
            }
            ...
            ?>
              ...
              <li class="nav-item ">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="ml-3 nav-item">
                    <a href="<?php echo $URL; ?>/admin/credito/index.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Credito</p>
                    </a>
                  </li>
                  <li class="ml-3 nav-item">
                    <a href="<?php echo $URL; ?>/admin/lista_cierres/buscador.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
            ...
            <?php
              ...
              unset($_SESSION['busqueda_cierres']);
            }
            ...
            ?>
              ...
              <li class="nav-item ">
                ...
                <ul class="nav nav-treeview">
                  <li class="ml-3 nav-item">
                    <a href="<?php echo $URL; ?>/admin/lista_cierres/contado.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Contado</p>
                    </a>
                  </li>
                  <li class="ml-3 nav-item">
                    <a href="<?php echo $URL; ?>/admin/lista_cierres/semicontado.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Semi Contado</p>
                    </a>
                  </li>
                  <li class="ml-3 nav-item">
                    <a href="<?php echo $URL; ?>/admin/lista_cierres/credito.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Credito</p>
                    </a>
                  </li>
            ...
            ?>
              ...
              <li class="nav-item ">
                ...
                <ul class="nav nav-treeview">
                  <li class="ml-3 nav-item">
                    <a href="<?php echo $URL; ?>/admin/legal/index.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Redactar Documentos</p>
                    </a>
                  </li>
                  <li class="ml-3 nav-item">
                    <a href="<?php echo $URL; ?>/admin/legal/listar.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Listar y Descargar</p>
                    </a>
                  </li>
                </ul>
              </li>
